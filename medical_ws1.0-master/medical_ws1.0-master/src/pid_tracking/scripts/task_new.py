    ...
    def config(self):
        ...
        if self.choose_data == 1:
            with self.sm:
                ...
                smach.StateMachine.add('RIGHT_POSITION_LOOP4', PositionLoopState(self.node, self.lidar_distance[2][2], axis=2), transitions={'succeeded': 'TASK7', 'in_progress': 'RIGHT_POSITION_LOOP4'})
