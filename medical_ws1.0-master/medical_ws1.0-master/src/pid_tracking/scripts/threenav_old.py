...
class TaskConfigManager:
    ...
    def _define_navigation_goals(self):
        ...
        return {
            ...
            2: {'position': [4.74, 2.29], 'name': '目标点2'},    # 药品区域1  
            3: {'position': [5.09, -1.41], 'name': '目标点3'},   # 药品区域2
    ...
    def _define_precise_distances(self):
        ...
        return {
            ...
            2: {'front': 0.45, 'left': 1.31, 'right': 5.83},
            3: {'front': 0.45, 'left': 5.76, 'right': 1.34},
...
class MainController:
    ...
    def goto_point_with_arm_task(self, point_id, task_id=None, enable_precise=None, precise_order=None, enable_imu_recovery=None):
        """前往指定点位，完成后执行机械臂任务"""
        rospy.loginfo(f"\n{'='*70}")
        ...
        if success and task_id is not None:
            ...
            if arm_success:
                ...
                if point_id == 2:
                    ...
                    target_distance = original_distance + 1.0
